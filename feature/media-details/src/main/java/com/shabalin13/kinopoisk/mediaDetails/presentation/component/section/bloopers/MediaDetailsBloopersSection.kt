package com.shabalin13.kinopoisk.mediaDetails.presentation.component.section.bloopers
...
internal fun MediaDetailsBloopersSection(
    ...
    Column(
        ...
        LazyRow(
            ...
            items(bloopers.take(MediaDetailsConfig.MAX_VISIBLE_BLOOPERS)) { blooper ->
                MediaDetailsNoteCard(
                    note = blooper,
                    onCardClick = { handleIntent(MediaDetailsIntent.BlooperCardClicked(blooper.text)) },
                    modifier = Modifier
                        .fillMaxHeight()
            ...
            if (bloopers.size > MediaDetailsConfig.MAX_VISIBLE_BLOOPERS) {
                item {
                    ShowAllCard(
